    ...
    return(
        <div className='flex min-h-screen items-center justify-center bg-cream'>
            <div className='w-full max-w-md rounded-2xl bg-white p-8 shadow-lg'>
                ...
                <p className='mb-6 text-sm text-gray-500'>Enter you email to reset password</p>
                <form onSubmit={handleSubmit} className='space-y-5'>
                    <div>
                        <label className='mb-2 block text-sm font-medium'>Email Address</label>
                        <div className='flex items-center rounded-lg border px-3'>
                            <Mail size={18} className='text-gray-400'/>
                            <input type='email' placeholder='Enter your email' className='w-full border-none bg-transparent px-3 py-3 outline-none' required/>
                        </div>
                    </div>
